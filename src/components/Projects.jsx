...
const Projects = () => {
  ...
  return (
    <div className="w-[80%] mx-auto flex flex-col gap-10 pb-10">
      <h2 className="text-black text-5xl font-semibold">Projects</h2>
        ...
        {data.map((veri) => (
          <div key={veri.title} className="flex flex-col  max-w-[30rem]">
            <img
              ...
              alt={veri.title}
            />
            <h2 className="text-3xl py-4 text-indigo-700 font-medium">
              {veri.title}
            </h2>
            <p>{veri.desc}</p>
            ...
            <div className="flex justify-between py-4 text-base font-medium underline leading-4 text-indigo-800">
