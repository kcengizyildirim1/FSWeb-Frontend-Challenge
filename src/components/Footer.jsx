const Footer = () => {
  return (
    <footer className="flex flex-col font-['Inter'] bg-[#F9F9F9]">
      <div className="w-[80%] mx-auto py-10">
        <h2 className="text-[2.625rem] max-w-[30rem] font-semibold">
          Let’s work together on your next product.
        </h2>
        <div className="flex justify-between mt-10 flex-wrap">
          <a href="#" className="text-xl">
            👉
            <span className="underline text-[#AF0C48] font-medium text-xl">
